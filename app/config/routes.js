...
import CEconomist from "../components/Pages/myFuture/Career-Economist.jsx";
...
import CareerDetail from "../components/Pages/myFuture/CareerDetail.jsx";
...
export default (
    <Route path="/" component={Main}>
        ...
        <Route path="future/career/economist" myFuture noFooter noNav component={CEconomist} />
        <Route path="future/career/:careerID" myFuture noFooter noNav handler={CareerDetail} component={CareerDetail} />
